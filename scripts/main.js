...
; (function (window) {
  ...
  let texts = [
    ...
    'SAME STAR',
    'WITH ME ?',
    'Sorry IF <br>I gave You',
    'the impression',
    'that I was <br> mad at you..',
    'Rin🎀chan',
    'I Just Miss <br>You SO MUCH',
    'You’re always<br>on my mind',
    'I Wanna Be <br> Your Hamster',
    'Forever',
    'No matter <br>  the distance, ',
    'you’re close to<br>my 💖',
    'Always 💕',
    'I Miss You!<br>So Much 🎀',
  ];
  ...
  function checkOrientation() {
    ...
    if (overlay) {
      if (window.innerWidth > window.innerHeight) {
        overlay.style.display = "none";   // landscape -> hide
      } else {
        overlay.style.display = "flex";   // portrait -> show
      }
    }
  }
  ...
  function draw() {
    ...
    // 👇 Split text into multiple lines if it has <br>
    let lines = text.split('<br>');
    let lineHeight = textSize * 1.2; // spacing between lines

    lines.forEach((line, i) => {
      ctx.fillText(
        line.trim(),
        (CANVASWIDTH - ctx.measureText(line.trim()).width) * 0.5, // center align
